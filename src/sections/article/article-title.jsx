    ...
    return (
        <div style={{ borderBottom: '1px solid #E4E8EB', borderRadius: '1px 1px 0px 0px', display: 'flex', flexDirection: 'column', backgroundColor: '#F9F9F9', marginLeft: "100px", marginRight: "100px" }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                <span style={{ fontSize: '24px', marginTop: '15px' }}>게시글 제목 ~~~</span>
                <div style={{ flexDirection: 'row', justifyContent: "space-between", display: 'flex', width: "100%", marginTop: "25px", alignItems: 'center' }}>
